...
import { AiToneStyle, CodeDiagnosisResult, CodeAnalysisIssue } from '../../types.ts';
import {
  Sparkles,
  Send,
  Code,
...
export const AiAssistantView: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'chat' | 'code_doctor' | 'toolbelt'>('chat');
  const [persona, setPersona] = useState<'code' | 'api' | 'security' | 'analyst' | 'docs'>('code');
